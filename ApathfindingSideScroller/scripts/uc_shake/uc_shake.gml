...
function uc_shake() {
	var shake_modifier = global.settings_screen_shake;
	...
	*/
	...
	if (argument_count>=1) Camera.shake_intensity = intensity * shake_modifier;
	if (argument_count==2) Camera.shake_acceleration = acc * shake_modifier;
