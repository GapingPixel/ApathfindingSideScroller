...
if instance_exists(plyr) && enemy_behavior = enemy_AIM && enemy_state = enemyState.NORMAL
{
	...
	if check_aim > 135 + angle_offset_2 && check_aim < 215 + angle_offset_2 && enemy_var_aim_angle != 180 //Left
	{
	...
	if (check_aim > 270 - angle_offset) && (check_aim < 270 + angle_offset) && enemy_var_aim_angle != 270//Down
	{
		enemy_var_aim_angle = 270;
		
		if anim != "0_idle_aim_fire_down"
