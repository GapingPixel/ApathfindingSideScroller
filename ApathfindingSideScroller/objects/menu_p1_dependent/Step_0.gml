/// @description Player 1 Inputs only
// You can write your code in this editor
menu_input_SELECT = max(gamepad_button_check_pressed(0,gp_face1), keyboard_check_pressed(vk_enter),0);
menu_input_BACK = max(gamepad_button_check_pressed(0,gp_face2), keyboard_check_pressed(vk_shift),0);
menu_input_UP = max(gamepad_button_check_pressed(0,gp_padu), keyboard_check_pressed(vk_up),0);
menu_input_DOWN= max(gamepad_button_check_pressed(0,gp_padd), keyboard_check_pressed(vk_down),0);
menu_input_LEFT= max(gamepad_button_check_pressed(0,gp_padl), keyboard_check_pressed(vk_left),0);
menu_input_RIGHT = max(gamepad_button_check_pressed(0,gp_padr), keyboard_check_pressed(vk_down),0);
...
#region//Analog Stick menu_input
    ...
    var analog_lsHor = gamepad_axis_value(0,gp_axislh)
    var analog_lsVer = gamepad_axis_value(0,gp_axislv)
