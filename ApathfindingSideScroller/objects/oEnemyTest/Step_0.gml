...
//Path finding trigger for bat to access pathfinding based on view
/*var triggerPF = collision_rectangle(global.cam_x + CELL_SIZE,
global.cam_y + CELL_SIZE,
global.cam_x + global.cam_width - CELL_SIZE,
global.cam_y + global.cam_height - CELL_SIZE)*/
	...
	switch(enemy_behavior)
	{
	   ...
	   /* if onGround
		...
		if alarm_get(1) < 0
		{
			...
			{
				skeleton_animation_set(choose("6_whacked","6_whacked2"));
			}
