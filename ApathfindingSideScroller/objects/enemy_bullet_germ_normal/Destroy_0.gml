...
//audio_sound_pitch(snd_enemy_slime_slimeglob_turn,random_range(2,3));
//audio_play_sound(snd_enemy_slime_slimeglob_turn,100,0);
...
part_particles_create(global.parsys,x,y,slime_boom,50);
