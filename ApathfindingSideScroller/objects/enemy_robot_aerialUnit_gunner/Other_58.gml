...
var bone_gun_point = ds_map_create();

skeleton_bone_state_get("gunL", bone_gun_point);
enemy_var_gun_x = ds_map_find_value(bone_gun_point,"worldX");
enemy_var_gun_y = ds_map_find_value(bone_gun_point,"worldY");
skeleton_bone_state_set("gunL", bone_gun_point);

ds_map_destroy(bone_gun_point);
