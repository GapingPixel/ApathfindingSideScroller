	...
	if enemy_behavior != enemy_KO
		...
		else
		{
		        ...
		        if anim = "3_fall"
				{
					...
					scr_play_sound(snd_common_liquid_splat_2,0,0.9,0.95)
		        ...
		        if ((image_index < 3 && image_index > 2))//first foot
		            {
		            scr_play_sound(snd_common_liquid_splat_1,0,1,1.01);}
		        if ((image_index < 15 && image_index > 14))//second foot
		            {
		            scr_play_sound(snd_common_liquid_splat_1,0,1.09,1.1);}
		        }
		}
		#endregion
